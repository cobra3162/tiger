...
<table width=100% align=left>
	<tr class='ht' height=25>
		...
		<td colspan=3>
			...
			<input type=radio onclick="goResultJp();"> 일본경마			
		</td>
	</tr>
...
?>
	<tr>
		<td colspan=4>
			<table width="100%"  border="0" cellpadding="1" cellspacing="1" bgcolor="cbac6f"><!--bgcolor="e0dad6" -->
			  <tr align="center">
				<td colspan="6" bgcolor="e0dad6"></td>
			  </tr>
		<tr  bgcolor="#e0dad6" height=25>
			<td width=60 align=center class="txt_main1">경기</td><td width=150 align=center class="txt_main1">1착</td><td width=150 align=center class="txt_main1">2착</td><td width=150 align=center class="txt_main1">3착</td>
			<td  align=center class="txt_main1">복승</td><td  align=center>쌍승</td>
			<td  align=center class="txt_main1">삼복승</td>
        </tr>
<?
} 
...
if(substr($race_kind,0,1)=='h') {
	...
	if (!$resno) {
		echo "<tr bgcolor='#e0dad6'><td colspan=7 align=center class='txt_main1' height=25>$res_str</td></tr>";
	} 
}
...
*/
	...
	if(substr($race_kind,0,1)=='h') {
		...
		<tr bgcolor=#ffffff height=25>
			<td align=center>$raceno</td>
			<td align=center width=150>&nbsp;$arrv01&nbsp;$arrv_name01</td>
			<td align=center width=150>&nbsp;$arrv02&nbsp;$arrv_name02</td>
			<td align=center width=150>&nbsp;$arrv03&nbsp;$arrv_name03</td>
			<td align=center>$doubl</td>
			<td align=center>$pair</td>
			<td align=center>$ddd</td>
		</tr>";
...
function goResult(kind) {
	...
	if ( kind == 6 ) 	{ document.fgo_result.race_kind.value = 'k03'; }
...
function goResultJp() {
    document.fgo_resultjp.race_date.value = <?=$race_date?> ;
    document.fgo_resultjp.submit();
}
...
<form name=fgo_resultjp method=post action="/jp_indexjp_main2.php" >
<!--<input type=hidden name=race_kind>-->
<input type=hidden name=race_date>
<input type=hidden name=jp_race value='yes'>
</form>
