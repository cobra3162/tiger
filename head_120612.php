					...
					<td align="center" valign="top" style="padding-top:26px;">
						...
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td width="49" align="center">
									<a href="javascript:openWin('http://kj999.kr/bs1.html')"><img src="/images/menu06.gif" onmouseover="this.src='/images/menu06_over.gif'" onmouseout="this.src='/images/menu06.gif'" border="0"></a></td>
							</tr>
						</table></td>
						<!----------------- #### 메뉴부분 끝 ------------->
				</tr>
			...
			<tr>
				...
				<td>
					<table border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td>
								<a href="javascript:openWin('http://okrace.dodo34.kr/bd_ko_pop.html')"><img src="/images/banner_tit_01.gif" onmouseover="this.src='/images/banner_tit_01_over.gif'" onmouseout="this.src='/images/banner_tit_01.gif'" border="0"></a></td>
						</tr>
						<tr height="6">
							<td></td>
						</tr>
						<tr>
							<td>
								<a href="javascript:openWin2('http://okrace.dodo34.kr/bd_ko_pop.html')"><img src="/images/banner_tit_02.gif" onmouseover="this.src='/images/banner_tit_02_over.gif'" onmouseout="this.src='/images/banner_tit_02.gif'" border="0"></a></td>
						</tr>
						<tr height="6">
							<td></td>
						</tr>
						<tr>
							<td>
								<a href="javascript:openWin('http://121.156.106.106:8900/board/chulju/frmnoticedetail_chulma.asp?y_no=740')"><img src="/images/banner_tit_03.gif" onmouseover="this.src='/images/banner_tit_03_over.gif'" onmouseout="this.src='/images/banner_tit_03.gif'" border="0"></a></td>
						</tr>
						<tr height="6">
							<td></td>
						</tr>
