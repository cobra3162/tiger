...
for ($i=0; $row=sql_fetch_array($result); $i++) 
{
	...
	elseif($race_kind == 'h01') $race_kind_str = "과천경마";
	elseif($race_kind == 'h02') $race_kind_str = "제주경마";
	elseif($race_kind == 'h03') $race_kind_str = "부산경마";
	elseif($race_kind == 'k01') $race_kind_str = "광명경륜";
	elseif($race_kind == 'k02') $race_kind_str = "창원경륜";
	elseif($race_kind == 'k03') $race_kind_str = "부산경륜";

    elseif($race_kind == '0') $race_kind_str = "일본경마(나고야)";
    elseif($race_kind == '1') $race_kind_str = "일본경마(미즈사와)";
    elseif($race_kind == '2') $race_kind_str = "일본경마(사가)";
	elseif($race_kind == '3') $race_kind_str = "일본경마(삿포로)";
	elseif($race_kind == '4') $race_kind_str = "일본경마(소노다)";
	elseif($race_kind == '5') $race_kind_str = "일본경마(아라오)";
    elseif($race_kind == '6') $race_kind_str = "일본경마(오네히로)";
    elseif($race_kind == '7') $race_kind_str = "일본경마(우라와)";
    elseif($race_kind == '8') $race_kind_str = "일본경마(카나지와)";
	elseif($race_kind == '9') $race_kind_str = "일본경마(코치)";
	elseif($race_kind == '10') $race_kind_str = "일본경마(쿠야마)";
	elseif($race_kind == '11') $race_kind_str = "일본경마(후나바시)";
    elseif($race_kind == '12') $race_kind_str = "일본경마(카와사키)";
    elseif($race_kind == '13') $race_kind_str = "일본경마(아시히키오)";
    elseif($race_kind == '14') $race_kind_str = "일본경마(카사마츠)";
	elseif($race_kind == '15') $race_kind_str = "일본경마(오오이)";
	elseif($race_kind == '16') $race_kind_str = "일본경마(몬베츠)";
	elseif($race_kind == '17') $race_kind_str = "일본경마(히메지)";
 
	if ( $jp=='1') {
    $sqlstart = "select no as raceid, start_$raceno as start from jp_raceinput where race_kind='$race_kind' and race_date = '$race_date_input'";
	//echo $sqlstart;
	}
    else  {$sqlstart = "select no as raceid, start_$raceno as start from raceinput where race_kind='$race_kind' and race_date = '$race_date_input'";
	//echo $sqlstart;
	}
