					...
					<td align="center" valign="top" style="padding-top:26px;">
						...
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td width="49" align="center">
									<a href="jp_ticket00.php"><img src="/images/menu04.gif" onmouseover="this.src='/images/menu04_over.gif'" onmouseout="this.src='/images/menu04.gif'" border="0"></a></td>
								<td width="49" align="center">
								...
								<td width="49" align="center">
									<a href="javascript:openWin('https://get.adobe.com/flashplayer/?loc=kr')"><img src="/images/menu06.gif" onmouseover="this.src='/images/menu06_over.gif'" onmouseout="this.src='/images/menu06.gif'" border="0"></a></td>
							</tr>
						</table></td>
						<!----------------- #### 메뉴부분 끝 ------------->
				</tr>
			...
			<tr>
				...
				<td>
					<table border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td>
								<a href="javascript:openWin('http://210.140.161.59/baedang/real_horse_baedang_2.asp?c_url=m2918.org&real_value=')"><img src="/images/jp_banner_tit_04.gif" onmouseover="this.src='/images/jp_banner_tit_04_over.gif'" onmouseout="this.src='/images/jp_banner_tit_04.gif'" border="0"></a></td>
						</tr>
						<tr height="5"><td></td></tr>
					</table></td>
			</tr>
