					...
					<td align="center" valign="top" style="padding-top:26px;">
						...
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td width="49" align="center">
									<a href="javascript:openWin('www.tu00.net/BC/S3.html')"><img src="/images/menu06.gif" onmouseover="this.src='/images/menu06_over.gif'" onmouseout="this.src='/images/menu06.gif'" border="0"></a></td>
							</tr>
						</table></td>
						<!----------------- #### 메뉴부분 끝 ------------->
				</tr>
