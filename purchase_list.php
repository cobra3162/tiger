...
<td>
				...
				회원아이디 <input type=text name=search_id size=10 maxsize=20 value=<?=$search_id?>>
...
for ($i=0; $row=sql_fetch_array($result); $i++) 
{
	...
	if($statusval=='cancle') {$status='취소'; $bgcolor="#ff0000"; }
...
//    echo $start_time."   ".$timenow;
    ...
    if ($start_time < $timenow) $check_str ='';  // 시간경과
