...
if ($race_kind=='h02') {$chk2 = 'checked'; $race_name='제주 경마'; $game_name ='h02'; $colspan=21; $over_h02='_over';}
elseif ($race_kind=='h03') {$chk3 = 'checked'; $race_name='부산 경마'; $game_name ='h03'; $colspan=21; $over_h03='_over';}
elseif ($race_kind=='k01') {$chk4 = 'checked'; $race_name='광명 경륜'; $game_name ='k01'; $colspan=11; $over_k01='_over';}
elseif ($race_kind=='k02') {$chk5 = 'checked'; $race_name='창원 경륜'; $game_name ='k02'; $colspan=11;$over_k02='_over';}
elseif ($race_kind=='k03') {$chk6 = 'checked'; $race_name='부산 경륜'; $game_name ='k03'; $colspan=11; $over_k03='_over';}
elseif ($race_kind=='t01') {$chk7 = 'checked'; $race_name='미사리 경정'; $game_name ='t01'; $colspan=11;$over_t01='_over';}
elseif ($race_kind=='h01') {$chk1 = 'checked'; $race_name='과천 경마'; $game_name ='h01'; $colspan=21;$over_h01='_over';}
...
<td width="85" align=center><b>8.</b></td>
<td width="85" align=center><b>9.</b></td>
<td width="85" align=center><b>10.</b></td>
</tr>
