...
elseif ($race_kind=='k01') {$chk4 = 'checked'; $race_name='광명 경륜'; $game_name ='k01'; $colspan=7;}
elseif ($race_kind=='k02') {$chk5 = 'checked'; $race_name='창원 경륜'; $game_name ='k02'; $colspan=7;}
elseif ($race_kind=='k03') {$chk6 = 'checked'; $race_name='부산 경륜'; $game_name ='k03'; $colspan=7;}
elseif ($race_kind=='t01') {$chk7 = 'checked'; $race_name='미사리 경정'; $game_name ='t01'; $colspan=7;}
...
<td width="570" style="PADDING-LEFT:5pt;" bgcolor='#FFFFFF' colspan=<?=$colspan-1?>><input type="text" style="text-align:right" name="totMoney" size="10" value=<?=$totalM?>>원</td>
</tr>
<tr>
...
<tr><td bgcolor="FFFFFF" colspan=<?=$colspan?>><font color=336699>서버의 운영상황에 따라 구매마감시간에 임박하여 구매가 이뤄지지 않을수가 있습니다
