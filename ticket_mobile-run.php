...
echo"
		...
		&nbsp;&nbsp;<b>경주시작시간 :<font color=red>starttime: $starttime</font>
...
battype_name[2]='쌍승'; 
battype_name[3]='삼복승'; 
battype_name[4]='복연승 1'; 
battype_name[5]='복연승 2'; 
battype_name[6]='복연승 3';
...
<!--
	<tr>
    <td height=5><img src="images/tit3-1.jpg" border="0"></td>
  </tr>-->
...
<!--<tr>
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1" >
      <tr>
        ...
        <!--
		<tr>
			<td height="28" bgcolor="#efefef" style="font-size:14px;">
				<table width="99%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td><font color="<?=$local_color[$data[local]]?>" style="font-size:14px;"><b><?=$data[local]?></b></font>
			          <?=$data[title]?><?=$race_name?>&nbsp;&nbsp;&nbsp;
					   <?=date("Y.m.d",$data[racedate])?><?=$race_date?>
			          (<?=$day_name[date("w",$data[racedate])]?><font color=blue style="font-size:14px;"><b><?=$data[rnd]?><?=$round?></b></font>Round 
					</td>
                    <td width="150"><marquee behavior=alternate scrolmount=10 ><span id="remain_timer_blink"  style="font-size:14px;font-weight:bold;color:red "></span></marquee></td>
              </tr>
              </table>
			</td>
        </tr>
        <tr>
			<td height="28" style="font-size:14px;">구매마감시간:<span id="remain_timer_<?=$data[no]?>" style="color:red;font-weight:bold;" >
	        <?=$remain_time_h?>
				:
			<?=$remain_time_m?>
				:
			<?=$remain_time_s?>
			</span>&nbsp;&nbsp;&nbsp;시작예정시간: <font color="red" style="font-size:14px;font-weight:bold;"><span id='hour_minute'>
			<?=date("H:i:s",$data[racedate])?>
			</span></font>
			</td>
      </tr>

<tr>
<td colspan=2 height="17" style="font-size:12px;">-->
...
<tr>
  ...
  <td height="25" valign="middle" style="PADDING-LEFT:5pt" bgcolor='#FFFFFF' colspan=<?=$colspan-1?>>
	<input name="pay_type" type="radio"   value="mile"
	<? if($enable_mile >= $enable_point) echo "checked";?> />
	<b>
	<?//=$racec[milename]?>현금머니
	<input name="pay_type" type="radio"  value="point"  <? if($enable_point > $enable_mile) echo "checked";?>  />
	<b>
...
?>
 ...
 월드레이스 끝 -->
		...
		<input name="bat_type" type="radio"  value="4"   onclick="javascript:SelectBat();" /><b>복연승 1</b>
		<input name="bat_type" type="radio"  value="5"   onclick="javascript:SelectBat();" /><b>복연승 2</b>
		<input name="bat_type" type="radio"  value="6"   onclick="javascript:SelectBat();" /><b>복연승 3</b>
</tr>
<tr>
