...
$cashmoney       = str_replace( ",", "", $_POST[cashmoney]);
$eventmoney      = str_replace( ",", "", $_POST[eventmoney]);				

$mb_4       = str_replace( ",", "", $_POST[mb_4]);
$mb_5      = str_replace( ",", "", $_POST[mb_5]);				
...
$sql_common = " mb_name         = '$_POST[mb_name]',
                ...
                mb_2            = '$_POST[mb_2]',
                mb_3            = '$_POST[mb_3]',
                cashmoney       = $cashmoney + $mb_4,				
                eventmoney      = $eventmoney + $mb_5 ";
...
else if ($w == "u")
{
	...
	$asql = " insert into account set id = '$mb_id', kind = 'manual', amount=$cashmoney, event = $eventmoney, status='confirm',
			  regdate = '$g4[time_ymdhis]', name='$mb[mb_name]'" ;
