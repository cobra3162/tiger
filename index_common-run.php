...
?>
	<tr>
		<td colspan=4>
			<table width="500"  border="0" cellpadding="1" cellspacing="1" bgcolor="cbac6f"><!--bgcolor="e0dad6" -->
			  <tr align="center">
				<td colspan="6" bgcolor="e0dad6"></td>
			  </tr>
		<tr  bgcolor="#e0dad6" height=25>
			<td width=60 align=center class="txt_main1">경기</td><td width=60 align=center class="txt_main1">1착</td><td width=60 align=center class="txt_main1">2착</td><td width=60 align=center class="txt_main1">3착</td>
			<td width=60 align=center class="txt_main1">복승</td><td width=60 align=center>쌍승</td>
			<td width=60 align=center class="txt_main1">삼복승</td>
        </tr>
<?
} 
